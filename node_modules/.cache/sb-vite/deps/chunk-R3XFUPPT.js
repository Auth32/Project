...
var E = /^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/;
var A = /^ *(?!<[a-z][^ >/]* ?\/>)<([a-z][^ >/]*) ?([^>]*)\/{0}>\n?(\s*(?:<\1[^>]*?>[\s\S]*?<\/\1>|(?!<\1)[\s\S])*?)<\/\1>\n*/i;
var O = /&([a-z0-9]+|#[0-9]{1,6}|#x[0-9a-fA-F]{1,6});/gi;
var T = /^<!--[\s\S]*?(?:-->)/;
...
var $e = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/;
var Se = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/;
var we = [u, m, g, w, E, C, T, B, ge, xe, ye, ve];
var Ce = [...we, /^[^\n]+(?:  \n|\n{2,})/, A, z];
function Ee(e2) {
...
function Oe(e2, n2, t2) {
  ...
  return i2.forEach(function(e3, n3) {
    "26" === e3.type ? 0 !== n3 && n3 !== i2.length - 1 && l2.push([]) : ("27" !== e3.type || null != i2[n3 + 1] && "26" !== i2[n3 + 1].type || (e3.text = e3.text.replace(Z, "")), l2[l2.length - 1].push(e3));
  }), l2;
}
function Te(e2, n2, t2) {
  t2.inline = true;
  const r2 = Oe(e2[1], n2, t2), i2 = e2[2].replace(G, "").split("|").map(Ae), l2 = function(e3, n3, t3) {
    ...
    return t3 ? t3.reduce(function(n3, t4, r3) {
      ...
      if (-1 !== i3) {
        const o2 = function(e2) {
          return -1 !== e2.indexOf("-") && null === e2.match(L) && (e2 = e2.replace(j, function(e3, n4) {
...
//# sourceMappingURL=chunk-R3XFUPPT.js.map
