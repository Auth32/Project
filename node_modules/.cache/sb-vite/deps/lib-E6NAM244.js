import {
  ...
  toUtf8Bytes,
  toUtf8String
} from "./chunk-CQR4LRYH.js";
import "./chunk-UDJG3RCY.js";
import "./chunk-G3OZKV4Z.js";
import "./chunk-F44S4J6N.js";
import {
  __toESM
...
var version3 = "providers/5.5.0";

// node_modules/@ethersproject/providers/lib.esm/formatter.js
var logger3 = new Logger(version3);
var Formatter = class _Formatter {
  constructor() {
    logger3.checkNew(new.target, _Formatter);
...
var BaseProvider = class extends Provider {
   ...
   */
  constructor(network) {
    logger4.checkNew(new.target, Provider);
    super();
    this._events = [];
  ...
  _getResolver(name2) {
    return __awaiter3(this, void 0, void 0, function* () {
      ...
      if (!network.ensAddress) {
        logger4.throwError("network does not support ENS", Logger.errors.UNSUPPORTED_OPERATION, { operation: "ENS", network: network.name });
      }
      const transaction = {
...
function checkError(method, error, params) {
  if (method === "call" && error.code === Logger.errors.SERVER_ERROR) {
    ...
    logger5.throwError("missing revert data in call exception", Logger.errors.CALL_EXCEPTION, {
      error,
      data: "0x"
    });
  }
...
var JsonRpcSigner = class _JsonRpcSigner extends Signer {
  constructor(constructorGuard, provider, addressOrIndex) {
    logger5.checkNew(new.target, _JsonRpcSigner);
    super();
...
var JsonRpcProvider = class _JsonRpcProvider extends BaseProvider {
  constructor(url, network) {
    logger5.checkNew(new.target, _JsonRpcProvider);
...
try {
  ...
  const logger17 = new Logger(version3);
  WS = function() {
...
var EtherscanProvider = class _EtherscanProvider extends BaseProvider {
  constructor(network, apiKey) {
    logger10.checkNew(new.target, _EtherscanProvider);
    super(network);
  ...
  getBaseUrl() {
    ...
    return logger10.throwArgumentError("unsupported network", "network", name);
  }
...
var FallbackProvider = class _FallbackProvider extends BaseProvider {
  constructor(providers, quorum) {
    logger11.checkNew(new.target, _FallbackProvider);
...
var PocketProvider = class extends UrlJsonRpcProvider {
  ...
  static getApiKey(apiKey) {
    if (apiKey == null) {
      logger14.throwArgumentError("PocketProvider.getApiKey does not support null apiKey", "apiKey", apiKey);
    }
    const apiKeyObj = {
      applicationId: null,
      loadBalancer: false,
    ...
    if (typeof apiKey === "string") {
      ...
      logger14.assertArgument(typeof apiKey.applicationId === "string", "applicationSecretKey requires an applicationId", "applicationId", apiKey.applicationId);
      logger14.assertArgument(typeof apiKey.applicationSecretKey === "string", "invalid applicationSecretKey", "applicationSecretKey", "[REDACTED]");
      apiKeyObj.applicationId = apiKey.applicationId;
      apiKeyObj.applicationSecretKey = apiKey.applicationSecretKey;
      apiKeyObj.loadBalancer = !!apiKey.loadBalancer;
    } else if (apiKey.applicationId) {
      logger14.assertArgument(typeof apiKey.applicationId === "string", "apiKey.applicationId must be a string", "apiKey.applicationId", apiKey.applicationId);
      apiKeyObj.applicationId = apiKey.applicationId;
      apiKeyObj.loadBalancer = !!apiKey.loadBalancer;
    } else {
...
var Web3Provider = class _Web3Provider extends JsonRpcProvider {
  constructor(provider, network) {
    logger15.checkNew(new.target, _Web3Provider);
    if (provider == null) {
...
//# sourceMappingURL=lib-E6NAM244.js.map
