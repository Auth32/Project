...
var metamask = {
  ...
  getIcon: async () => (await import("./metamask-KDENLZKJ.js")).default,
...
var infinitywallet = {
  ...
  getIcon: async () => (await import("./infinitywallet-RP7H2X6A.js")).default,
...
var exodus = {
  ...
  getIcon: async () => (await import("./exodus-QT5QZN5Q.js")).default,
...
var frontier = {
  ...
  getIcon: async () => (await import("./frontier-OSB4FB3W.js")).default,
  getInterface: async () => ({
...
var brave = {
  ...
  getIcon: async () => (await import("./brave-CH3DVRNE.js")).default,
...
var binance = {
  ...
  getIcon: async () => (await import("./binance-P2AW3ZH6.js")).default,
  getInterface: async () => {
    let tempBNBProvider = {
      ...window.BinanceChain
    };
...
var coinbase = {
  ...
  getIcon: async () => (await import("./coinbase-NLEWQXW3.js")).default,
  getInterface: async () => {
...
var detected = {
  ...
  getIcon: async () => (await import("./detected-IBL3GBSG.js")).default,
  getInterface: async () => ({
...
var trust = {
  ...
  getIcon: async () => (await import("./trust-HGCCETOR.js")).default,
  getInterface: async () => {
...
var opera = {
  ...
  getIcon: async () => (await import("./opera-KGJTC5P2.js")).default,
  getInterface: async () => ({
...
var status = {
  ...
  getIcon: async () => (await import("./status-O7C33UEV.js")).default,
  getInterface: async () => {
...
var alphawallet = {
  ...
  getIcon: async () => (await import("./alphawallet-U53K3DNV.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var apexwallet = {
  ...
  getIcon: async () => (await import("./apexwallet-CVUC6OYK.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
...
var atoken = {
  ...
  getIcon: async () => (await import("./atoken-TQ6C336B.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var bifrostwallet = {
  ...
  getIcon: async () => (await import("./bifrostwallet-P6B2GBNS.js")).default,
...
var bitpie = {
  ...
  getIcon: async () => (await import("./bitpie-GBZUH7H7.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var blockwallet = {
  ...
  getIcon: async () => (await import("./blockwallet-2O2BNN5M.js")).default,
...
var frame = {
  ...
  getIcon: async () => (await import("./frame-W4ELIPHI.js")).default,
  getInterface: async () => {
    const provider = window.ethereum;
...
var huobiwallet = {
  ...
  getIcon: async () => (await import("./huobiwallet-IKSNVNWC.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var hyperpay = {
  ...
  getIcon: async () => (await import("./hyperpay-A2HYMSQV.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var imtoken = {
  ...
  getIcon: async () => (await import("./imtoken-KDPBQ5R3.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      eth_selectAccounts: UNSUPPORTED_METHOD
    })
...
var liquality = {
  ...
  getIcon: async () => (await import("./liquality-KYZTFRZU.js")).default,
  getInterface: async () => {
...
var meetone = {
  ...
  getIcon: async () => (await import("./meetone-IMOPSS3G.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var mykey = {
  ...
  getIcon: async () => (await import("./mykey-URWHMMKK.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var ownbit = {
  ...
  getIcon: async () => (await import("./ownbit-ZNZ7ZE3S.js")).default,
  getInterface: async () => {
    const provider = createEIP1193Provider(window.ethereum, {
      eth_chainId: ({ baseRequest }) => baseRequest({ method: "eth_chainId" }).then((id) => `0x${parseInt(id).toString(16)}`),
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
...
var tokenpocket = {
  ...
  getIcon: async () => (await import("./tokenpocket-Y3GFEO3X.js")).default,
...
var tp = {
  ...
  getIcon: async () => (await import("./tp-HNBTB4TP.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var xdefi = {
  ...
  getIcon: async () => (await import("./xdefi-CTDUR3TF.js")).default,
  getInterface: async () => ({
...
var oneInch = {
  ...
  getIcon: async () => (await import("./oneInch-4MJWTLQG.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["mobile"]
...
var tokenary = {
  ...
  getIcon: async () => (await import("./tokenary-NSRFRZUG.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["all"]
...
var tally = {
  ...
  getIcon: async () => (await import("./tallywallet-SMCLH6KX.js")).default,
  getInterface: async () => ({
...
var zeal = {
  ...
  getIcon: async () => (await import("./zeal-MXV3AUVU.js")).default,
  getInterface: async () => ({
...
var rabby = {
  ...
  getIcon: async () => (await import("./rabby-Y3XSLMYN.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["desktop"]
...
var mathwallet = {
  ...
  getIcon: async () => (await import("./mathwallet-U4JLS4AU.js")).default,
...
var gamestop = {
  ...
  getIcon: async () => (await import("./gamestop-MUS3NZRB.js")).default,
  getInterface: async () => {
...
var bitget = {
  ...
  getIcon: async () => (await import("./bitget-E2UPB7AN.js")).default,
  getInterface: async () => ({
...
var sequence = {
  ...
  getIcon: async () => (await import("./sequence-UAWKT6WV.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["all"]
...
var core = {
  ...
  getIcon: async () => (await import("./core-U2ML5TWE.js")).default,
...
var bitski = {
  ...
  getIcon: async () => (await import("./bitski-6UEJQMQK.js")).default,
  getInterface: async () => ({
...
var zerion = {
  ...
  getIcon: async () => (await import("./zerion-IR34QGTT.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["all"]
...
var enkrypt = {
  ...
  getIcon: async () => (await import("./enkrypt-DWGYVPRB.js")).default,
  getInterface: async () => {
...
var phantom = {
  ...
  getIcon: async () => (await import("./phantom-ESLCHBVM.js")).default,
  getInterface: async () => ({
...
var safepal = {
  ...
  getIcon: async () => (await import("./safepal-JZEOCEGG.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["all"]
...
var rainbow = {
  ...
  getIcon: async () => (await import("./rainbow-TV6MDBKO.js")).default,
...
var okxwallet = {
  ...
  getIcon: async () => (await import("./okxwallet-AZIGVZQY.js")).default,
  getInterface: async () => ({
...
var defiwallet = {
  ...
  getIcon: async () => (await import("./defiwallet-Z2JZAJS4.js")).default,
  getInterface: async () => ({
...
var safeheron = {
  ...
  getIcon: async () => (await import("./safeheron-H4ZEXQP5.js")).default,
  getInterface: async () => ({
...
var talisman = {
  ...
  getIcon: async () => (await import("./talisman-OPDOD5TZ.js")).default,
  getInterface: async () => ({
...
var ronin = {
  ...
  getIcon: async () => (await import("./roninwallet-ADZ567J5.js")).default,
  getInterface: async () => ({
...
var onekey = {
  ...
  getIcon: async () => (await import("./onekey-4RLPLZV6.js")).default,
  getInterface: async () => ({
...
var fordefi = {
  ...
  getIcon: async () => (await import("./fordefi-4JFVJZU6.js")).default,
...
var coin98wallet = {
  ...
  getIcon: async () => (await import("./coin98wallet-G6YPO3SA.js")).default,
  getInterface: async () => {
    const ethereumInjectionExists = window.hasOwnProperty(InjectedNameSpace.Ethereum);
    let provider;
...
var subwallet = {
  ...
  getIcon: async () => (await import("./subwallet-TROPIRHL.js")).default,
  getInterface: async () => ({
...
var kayros = {
  ...
  getIcon: async () => (await import("./kayros-VJZT45A6.js")).default,
  getInterface: async () => ({
...
var foxwallet = {
  ...
  getIcon: async () => (await import("./foxwallet-XOE3NEZU.js")).default,
  getInterface: async () => ({
