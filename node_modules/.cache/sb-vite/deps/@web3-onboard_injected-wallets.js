...
var metamask = {
  ...
  getIcon: async () => (await import("./metamask-O7TXCVA4.js")).default,
...
var infinitywallet = {
  ...
  getIcon: async () => (await import("./infinitywallet-JMHILCCJ.js")).default,
...
var exodus = {
  ...
  getIcon: async () => (await import("./exodus-DF22TAYP.js")).default,
...
var frontier = {
  ...
  getIcon: async () => (await import("./frontier-GSCIHOOA.js")).default,
  getInterface: async () => ({
...
var brave = {
  ...
  getIcon: async () => (await import("./brave-ITZBC2FQ.js")).default,
...
var binance = {
  ...
  getIcon: async () => (await import("./binance-P6UF2MNI.js")).default,
  getInterface: async () => {
    let tempBNBProvider = {
      ...window.BinanceChain
    };
...
var coinbase = {
  ...
  getIcon: async () => (await import("./coinbase-YPHO2Q5D.js")).default,
  getInterface: async () => {
...
var detected = {
  ...
  getIcon: async () => (await import("./detected-GC42XX4D.js")).default,
  getInterface: async () => ({
...
var trust = {
  ...
  getIcon: async () => (await import("./trust-LZ273USH.js")).default,
  getInterface: async () => {
...
var opera = {
  ...
  getIcon: async () => (await import("./opera-OVLWMF6W.js")).default,
  getInterface: async () => ({
...
var status = {
  ...
  getIcon: async () => (await import("./status-I2TAHG4S.js")).default,
  getInterface: async () => {
...
var alphawallet = {
  ...
  getIcon: async () => (await import("./alphawallet-HAEGWFGD.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var apexwallet = {
  ...
  getIcon: async () => (await import("./apexwallet-SGXWSWJY.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
...
var atoken = {
  ...
  getIcon: async () => (await import("./atoken-X4I33UHI.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var bifrostwallet = {
  ...
  getIcon: async () => (await import("./bifrostwallet-W6FIQ4BU.js")).default,
...
var bitpie = {
  ...
  getIcon: async () => (await import("./bitpie-CUD3MWNQ.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var blockwallet = {
  ...
  getIcon: async () => (await import("./blockwallet-452RBFMD.js")).default,
...
var frame = {
  ...
  getIcon: async () => (await import("./frame-UD233GS5.js")).default,
  getInterface: async () => {
    const provider = window.ethereum;
...
var huobiwallet = {
  ...
  getIcon: async () => (await import("./huobiwallet-HSR43HJS.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var hyperpay = {
  ...
  getIcon: async () => (await import("./hyperpay-NEPXUCRM.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var imtoken = {
  ...
  getIcon: async () => (await import("./imtoken-BXYZN3HG.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      eth_selectAccounts: UNSUPPORTED_METHOD
    })
...
var liquality = {
  ...
  getIcon: async () => (await import("./liquality-4KZ7LFJY.js")).default,
  getInterface: async () => {
...
var meetone = {
  ...
  getIcon: async () => (await import("./meetone-JVEEWPT5.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var mykey = {
  ...
  getIcon: async () => (await import("./mykey-ZZB4WPX6.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var ownbit = {
  ...
  getIcon: async () => (await import("./ownbit-G6UHRA4I.js")).default,
  getInterface: async () => {
    const provider = createEIP1193Provider(window.ethereum, {
      eth_chainId: ({ baseRequest }) => baseRequest({ method: "eth_chainId" }).then((id) => `0x${parseInt(id).toString(16)}`),
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
...
var tokenpocket = {
  ...
  getIcon: async () => (await import("./tokenpocket-Z2TNMG6M.js")).default,
...
var tp = {
  ...
  getIcon: async () => (await import("./tp-GWQVKREN.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var xdefi = {
  ...
  getIcon: async () => (await import("./xdefi-BEIWY63T.js")).default,
  getInterface: async () => ({
...
var oneInch = {
  ...
  getIcon: async () => (await import("./oneInch-DKCUNZXE.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["mobile"]
...
var tokenary = {
  ...
  getIcon: async () => (await import("./tokenary-VR6DVQ5C.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["all"]
...
var tally = {
  ...
  getIcon: async () => (await import("./tallywallet-INMQ6EOD.js")).default,
  getInterface: async () => ({
...
var zeal = {
  ...
  getIcon: async () => (await import("./zeal-B3HMDD3F.js")).default,
  getInterface: async () => ({
...
var rabby = {
  ...
  getIcon: async () => (await import("./rabby-LJTPO2SF.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["desktop"]
...
var mathwallet = {
  ...
  getIcon: async () => (await import("./mathwallet-GLATQ2YF.js")).default,
...
var gamestop = {
  ...
  getIcon: async () => (await import("./gamestop-IR3CSA6D.js")).default,
  getInterface: async () => {
...
var bitget = {
  ...
  getIcon: async () => (await import("./bitget-2FX4I22W.js")).default,
  getInterface: async () => ({
...
var sequence = {
  ...
  getIcon: async () => (await import("./sequence-5PXB5FWB.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["all"]
...
var core = {
  ...
  getIcon: async () => (await import("./core-AFHIRI4G.js")).default,
...
var bitski = {
  ...
  getIcon: async () => (await import("./bitski-MIDONPZO.js")).default,
  getInterface: async () => ({
...
var zerion = {
  ...
  getIcon: async () => (await import("./zerion-VEP5YK46.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["all"]
...
var enkrypt = {
  ...
  getIcon: async () => (await import("./enkrypt-TOEDZTMQ.js")).default,
  getInterface: async () => {
...
var phantom = {
  ...
  getIcon: async () => (await import("./phantom-3J3ZD3XJ.js")).default,
  getInterface: async () => ({
...
var safepal = {
  ...
  getIcon: async () => (await import("./safepal-RT6Y3TTQ.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["all"]
...
var rainbow = {
  ...
  getIcon: async () => (await import("./rainbow-4JCHRK75.js")).default,
...
var okxwallet = {
  ...
  getIcon: async () => (await import("./okxwallet-HBYUQ66M.js")).default,
  getInterface: async () => ({
...
var defiwallet = {
  ...
  getIcon: async () => (await import("./defiwallet-ERM5DJWS.js")).default,
  getInterface: async () => ({
...
var safeheron = {
  ...
  getIcon: async () => (await import("./safeheron-MCUHDT4U.js")).default,
  getInterface: async () => ({
...
var talisman = {
  ...
  getIcon: async () => (await import("./talisman-F2K7KLZX.js")).default,
  getInterface: async () => ({
...
var ronin = {
  ...
  getIcon: async () => (await import("./roninwallet-JK3QWFL4.js")).default,
  getInterface: async () => ({
...
var onekey = {
  ...
  getIcon: async () => (await import("./onekey-EMQNGGII.js")).default,
  getInterface: async () => ({
...
var fordefi = {
  ...
  getIcon: async () => (await import("./fordefi-PS2CRHUZ.js")).default,
...
var coin98wallet = {
  ...
  getIcon: async () => (await import("./coin98wallet-7D72CHW7.js")).default,
  getInterface: async () => {
    const ethereumInjectionExists = window.hasOwnProperty(InjectedNameSpace.Ethereum);
    let provider;
...
var subwallet = {
  ...
  getIcon: async () => (await import("./subwallet-RQZ7M2TZ.js")).default,
  getInterface: async () => ({
...
var kayros = {
  ...
  getIcon: async () => (await import("./kayros-OU7ZS63Q.js")).default,
  getInterface: async () => ({
...
var foxwallet = {
  ...
  getIcon: async () => (await import("./foxwallet-QZWENDHU.js")).default,
  getInterface: async () => ({
